...
__powerline() {
    ...
    ps1() {
		...
		#PS1_t="\`if [ \$? = 0 ]; then echo \[\e[33m\]\[\e[0m\]; else echo \[\e[31m\]\[\e[0m\]; fi\` \[\033[35m\]\t\[\033[36m\]\u\[\033[m\]@\[\033[32m\]\h:\[\033[33;1m\]\w\[\033[m\]"
		
		PS1_t="\`if [ \$? = 0 ]; then echo \[\e[33m\] \[\e[0m\]; else echo \[\e[31m\] \[\e[0m\]; fi\`\[\033[38;5;172m\]\t\[$(tput sgr0)\]\[\033[38;5;33m\]:\[$(tput sgr0)\]\[\033[38;5;3m\]\u@\H\[$(tput sgr0)\]\n \[$(tput sgr0)\]\[\033[38;5;66m\]>\[$(tput sgr0)\] \[$(tput sgr0)\]\[\033[38;5;37m\]\w:\[$(tput sgr0)\] \[\033[38;5;107m\]\\$\[$(tput sgr0)"
